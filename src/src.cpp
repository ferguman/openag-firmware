...
void loop() {
   ...
   // If command is not a food computer actuator command set or the food computer loop is off then
   ...
   // A food computer command has been detected and the food computer loop is enabled so
